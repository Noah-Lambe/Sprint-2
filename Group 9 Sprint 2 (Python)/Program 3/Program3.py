...
def main():
    ...
    while True:
        ...
        # Format values.
        costDSP = FDollar2(cost)
        itemTotalDSP = FDollar2(itemTotal)
        hstDSP = FDollar2(hst)
        subtotalDSP = FDollar2(subtotal)
        totalDSP = FDollar2(total)
        ...
        print("----------------------------------------------------------")
        print(f"Item Cost:   {costDSP:>10s}        Item Quantity:   {quantity:>10d}")
        print(f"Item Total:  {itemTotalDSP:>10s}        HST:             {hstDSP:>10s}")
        print(f"subtotal:    {subtotalDSP:>10s}        Total:           {totalDSP:>10s}")
